          ...
          <div className="events-details-cards-render-cover">
            ...
            <div className="events-details-cards-right-cover">
              ...
              <div className="events-details-cards-description">
                A MARATHON EVENT IS A LONG-DISTANCE RUNNING RACE WITH AN
                OFFICIAL DISTANCE OF 42.195 KILOMETERS (26 MILES AND 385 YARDS).
                THE MARATHON IS ONE OF THE MOST ICONIC AND CHALLENGING ENDURANCE
                RACES, ATTRACTING RUNNERS FROM ALL AROUND THE WORLD. COMPLETING
                A MARATHON IS A PROFOUND PERSONAL ACHIEVEMENT THAT INSTILLS A
                SENSE OF PRIDE, ACCOMPLISHMENT, AND CAMARADERIE AMONG
                PARTICIPANTS. IT REQUIRES MENTAL TOUGHNESS, DETERMINATION, AND
                DEDICATION TO OVERCOME THE PHYSICAL AND MENTAL CHALLENGES OF THE
                RACE.
              </div>
              ...
              <div className="events-details-cards-register-btn-cover">
                <div className="events-details-cards-register-btn">
                  Register
                </div>
              </div>
            </div>
